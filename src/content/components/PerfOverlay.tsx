...
export function PerfOverlay({ visible }: PerfOverlayProps) {
  ...
  return (
    <div className="chatlog-perf-overlay">
      ...
      <div className="chatlog-perf-row">full parses: {counters.fullParses}</div>
      <div className="chatlog-perf-row">slow parses (50/100): {counters.slowParsesOver50ms}/{counters.slowParsesOver100ms}</div>
    </div>
  );
}
